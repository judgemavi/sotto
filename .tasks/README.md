...
| V1 | vault | ~~T088~~ | **Withdrawn 2026-08-16.** The maintainer wanted editable summaries, which T087 delivered; the markdown mirror, `sotto://` scheme and vault folder were extrapolation and are removed. ADR-0021 decision 3 is struck through. |
