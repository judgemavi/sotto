...
| N8 | entry workspace | T086 → T089 | ADR-0021. T086 in-progress: the entry relation, prepared-entry APIs, cascade, and v13 migration are implemented and green; title adoption remains blocked on T085 releasing `session_titles`. T089 (blocked on T086 + N7 close) cuts the workspace over to entries: prepared entries before capture, record-again into an entry, `docs/design/workspace-v3-mock.html` normative. |
